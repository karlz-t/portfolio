    ...
    <div className="max-w-6xl mx-auto px-6">
      ...
      <main className="space-y-16">
        ...
        <section id="contact" className="grid md:grid-cols-2 gap-8">
          ...
          <form className="p-6 rounded-lg bg-zinc-900/20">
            <label className="block text-sm text-zinc-300">Name</label>
            <input className="mt-1 w-full p-2 rounded bg-transparent border border-zinc-800 text-sm" placeholder="Your name" />
            <label className="block text-sm text-zinc-300 mt-3">Email</label>
            <input className="mt-1 w-full p-2 rounded bg-transparent border border-zinc-800 text-sm" placeholder="Your email" />
            <label className="block text-sm text-zinc-300 mt-3">Message</label>
            <textarea className="mt-1 w-full p-2 rounded bg-transparent border border-zinc-800 text-sm h-28" placeholder="How can I help?" />
            <button type="button" className="mt-4 px-4 py-2 rounded bg-neon-cyan text-black">Send Message</button>
          </form>
        </section>
      </main>
